# Fiksni makroi s Pythonove strane
# INC, DEC; ZERO, MOVE, REMOVE; MEMMOVE, CALL

from pj import *


class LOOP(enum.Enum):
    INC, DEC, ZERO, MOVE, REMOVE = 'INC', 'DEC', 'ZERO', 'MOVE', 'REMOVE'
    MMOVE, CALL = 'MMOVE', 'CALL'
    TOČKAZ, VOTV, VZATV = ';{}'
...
# program -> naredba*
# naredba -> opkod arg TOČKAZ | IME arg+ TOČKAZ | arg VOTV program VZATV
# opkod -> INC | DEC
# arg -> R | IME
